========================================================================
    APLICACIÓN DE CONSOLA: criptografia trabajo 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación criptografia trabajo.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación criptografia trabajo.


criptografia trabajo.vcxproj
...
criptografia trabajo.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado criptografia trabajo.pch y un archivo de tipos 
